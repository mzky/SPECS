...
#CONFIG_OPTS="$CONFIG_OPTS --enable-libiptc-dynamic"
#CONFIG_OPTS="$CONFIG_OPTS --disable-libipset-dynamic"
#CONFIG_OPTS="$CONFIG_OPTS --enable-libnl-dynamic"
...
#CONFIG_OPTS="$CONFIG_OPTS --enable-json"
#CONFIG_OPTS="$CONFIG_OPTS --with-init=upstart"
CONFIG_OPTS="$CONFIG_OPTS --with-init=systemd"
#CONFIG_OPTS="$CONFIG_OPTS --with-init=SYSV"
#CONFIG_OPTS="$CONFIG_OPTS --with-init=SUSE"
#CONFIG_OPTS="$CONFIG_OPTS --with-init=openrc"
#CONFIG_OPTS="$CONFIG_OPTS --enable-regex"
#CONFIG_OPTS="$CONFIG_OPTS --enable-bfd"
#CONFIG_OPTS="$CONFIG_OPTS --enable-strict-config-checks"
...
#%{__mv} %{buildroot}%{_initrddir}/keepalived.suse.init %{buildroot}%{_initrddir}/keepalived
...
#	/sbin/stop keepalived >/dev/null 2>&1 || :
:
fi
